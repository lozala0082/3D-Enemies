...
public class PlayerMovement : MonoBehaviour
{
    ...
    {
        //For wallrunning
        //so the queston is who sets the wall running variable...
        WallRunning();
    }
    ...
    private void Jump()
    {
        ...
        Debug.Log("In the jump function");
        Debug.Log("Something is not triggering...");
        Debug.Log(grounded);
        ...
        {
            Debug.Log("LOOK YOU ARE JUMPING!!!!!! right???");
            ...
            {
                wallRunning = false;
                Debug.Log("wallRunning is now FALSE");
            }
        }
    }
    ...
    {
        Debug.Log("We need to set grounded....");
        Debug.Log("Did this trigger?");
        Debug.Log("What is other???");
        Debug.Log(other.gameObject);
        int layer = other.gameObject.layer;
        Debug.Log("What is layer?");
        Debug.Log(layer);
        ...
        for (int i = 0; i < other.contactCount; i++)
        {
            ...
            if (IsFloor(normal))
            {
                ...
                {
                    wallRunning = false;
                    Debug.Log("wallRunning is FAAAAALSe per the for loop");
                }
                grounded = true;
                normalVector = normal;
            ...
            {
                Debug.Log("So wall Running must be changed here then...");
                StartWallRun(normal);
                onWall = true;
        ...
        if (!cancellingWall)
        {
            Debug.Log("Stop wall is being invoked :(");
            cancellingWall = true;
